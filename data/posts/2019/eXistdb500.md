...
original-id: "eXistdb500"
original-url: "https://exist-db.org/exist/apps/wiki/blogs/eXist/eXistdb500"
---
...
* Added XQuery 3.1 [`fn:contains-token`]({docs}/functions/fn/contains-token) [#2799](https://github.com/eXist-db/exist/pull/2799), [`fn:parse-ietf-date`]({docs}/functions/fn/parse-ietf-date)  [#2866](https://github.com/eXist-db/exist/pull/2866), and  [`fn:random-number-generator`]({docs}/functions/fn/random-number-generator) functions.
